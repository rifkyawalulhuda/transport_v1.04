          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <input v-model="form.chasis_no" type="text" class="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                <p v-if="errors.chasis_no" class="mt-1 text-xs text-error-600">
                  {{ errors.chasis_no }}
                </p>
              </div>
              <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div class="flex items-center gap-3">
                  <label for="chasis-dok-keur" class="inline-flex cursor-pointer items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200">
                    Pilih File
                  </label>
                ...
                <input id="chasis-dok-keur" type="file" class="sr-only" @change="handleFileChange($event, 'dok_keur')" multiple />
...
const currentPageTitle = 'Input Data Chasis'
