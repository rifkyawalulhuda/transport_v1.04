...
const translations = {
  id: {
    ...
    tabInsiden: 'Insiden',
     tabRiwayat: 'Riwayat',
     tabAlarm: 'Alarm ADAS',
     alarmTitle: 'Import Alarm ADAS',
     alarmSub: 'Impor data alarm keselamatan dari file CSV atau XLSX.',
     alarmChooseFile: 'Pilih File',
     alarmUploading: 'Mengimpor...',
     alarmDropHint: 'Klik area ini untuk memilih file CSV/XLSX',
     alarmInserted: 'Berhasil diimpor',
     alarmBurst: 'Alarm Beruntun (dedup)',
     alarmDuplicates: 'Duplikat',
     alarmNoDriver: 'Driver belum terdaftar',
     alarmFailed: 'Gagal',
     alarmListTitle: 'Alarm ADAS Terimpor',
     alarmPlate: 'Plat kendaraan',
     alarmSelectDate: 'Pilih tanggal',
     alarmAllTypes: 'Semua tipe alarm',
     alarmTime: 'Waktu',
     alarmType: 'Tipe Alarm',
     alarmDriver: 'Driver',
     alarmLocation: 'Lokasi',
    ...
    // ADAS score section (dashboard)
    adasScoreTitle: 'Skor Perilaku Berkendara (ADAS/DMS)',
    adasScoreHint: 'Berdasarkan data alarm ADAS pada bulan terpilih · 100 = sangat baik',
    adasScoreEmpty: 'Belum ada data alarm ADAS pada bulan ini',
    adasScoreRank: 'Peringkat',
    adasScorePlate: 'Kendaraan',
    adasScoreOverall: 'Skor',
    adasScoreFatigue: 'Kelelahan',
    adasScoreDistraction: 'Distraksi',
    adasScoreCollision: 'Jarak Aman',
    adasScoreLane: 'Lajur',
    adasScoreSpeed: 'Kecepatan',
    adasScoreAlarms: 'Alarm',
  ...
  en: {
    ...
    tabInsiden: 'Incident',
     tabRiwayat: 'History',
     tabAlarm: 'ADAS Alarms',
     alarmTitle: 'Import ADAS Alarms',
     alarmSub: 'Import safety alarm data from a CSV or XLSX file.',
     alarmChooseFile: 'Choose File',
     alarmUploading: 'Importing...',
     alarmDropHint: 'Click this area to choose a CSV/XLSX file',
     alarmInserted: 'Imported',
    alarmBurst: 'Repeated alarms (dedup)',
     alarmDuplicates: 'Duplicates',
     alarmNoDriver: 'Driver not registered',
     alarmFailed: 'Failed',
     alarmListTitle: 'Imported ADAS Alarms',
     alarmPlate: 'Vehicle plate',
     alarmSelectDate: 'Select date',
     alarmAllTypes: 'All alarm types',
     alarmTime: 'Time',
    ...
    // ADAS score section (dashboard)
    adasScoreTitle: 'Driving Behavior Score (ADAS/DMS)',
    adasScoreHint: 'Based on ADAS alarm data for the selected month · 100 = excellent',
    adasScoreEmpty: 'No ADAS alarm data for this month',
    adasScoreRank: 'Rank',
    adasScorePlate: 'Vehicle',
    adasScoreOverall: 'Score',
    adasScoreFatigue: 'Fatigue',
    adasScoreDistraction: 'Distraction',
    adasScoreCollision: 'Safe Distance',
    adasScoreLane: 'Lane',
    adasScoreSpeed: 'Speed',
    adasScoreAlarms: 'Alarms',
