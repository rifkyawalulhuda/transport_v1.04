...
const translations = {
  id: {
    ...
    // Speed tab
    tabSpeed: 'Kecepatan',
    speedTitle: 'Import Data Kecepatan',
    speedSub: 'Impor data pelanggaran kecepatan dari file CSV atau XLSX.',
    speedChooseFile: 'Pilih File',
    speedUploading: 'Mengimpor...',
    speedDropHint: 'Klik area ini untuk memilih file CSV/XLSX',
    speedInserted: 'Berhasil diimpor',
    speedBurst: 'Beruntun (dedup)',
    speedDuplicates: 'Duplikat',
    speedNoDriver: 'Driver belum terdaftar',
    speedFailed: 'Gagal',
    speedSummaryTitle: 'Ringkasan Kecepatan',
    speedTotalEvents: 'Total Pelanggaran',
    speedVehiclesAffected: 'Kendaraan Terlibat',
    speedAvgExcess: 'Rata-rata Kelebihan (km/j)',
    speedMaxExcess: 'Maks. Kelebihan (km/j)',
    speedTopOffender: 'Pelanggar Terbanyak',
    speedTrendTitle: 'Tren Pelanggaran Kecepatan',
    speedByVehicleTitle: 'Pelanggaran per Kendaraan',
    speedListTitle: 'Daftar Pelanggaran Kecepatan',
    speedPlate: 'Plat kendaraan',
    speedSelectDate: 'Pilih tanggal',
    speedTime: 'Waktu',
    speedDriver: 'Driver',
    speedLocation: 'Lokasi',
    speedKmh: 'Kecepatan (km/j)',
    speedLimit: 'Batas (km/j)',
    speedExcess: 'Kelebihan (km/j)',
    speedNoData: 'Belum ada data pelanggaran kecepatan',
    speedRecords: 'data',
    speedSettingsTitle: 'Pengaturan Kecepatan',
    speedDefaultLimit: 'Batas Kecepatan Default (km/j)',
    speedSaveSettings: 'Simpan Pengaturan',
    speedSettingsSaved: 'Pengaturan berhasil disimpan',
    speedStorageInfo: 'Hemat penyimpanan',
    speedMonthFilter: 'Filter bulan untuk seluruh tab Kecepatan',

    // Retensi data (ADAS & Speed)
    retentionTitle: 'Retensi Data',
    retentionSub: 'Hapus permanen data yang lebih tua dari N hari. 0 = nonaktif. Angka di kotak langsung dipakai saat klik Hapus Data. Hanya admin.',
    retentionAdas: 'ADAS (hari)',
    retentionSpeed: 'Speed (hari)',
    retentionPreviewBtn: 'Pratinjau',
    retentionPurgeBtn: 'Hapus Data',
    retentionConfirmBtn: 'Konfirmasi Hapus',
    retentionSave: 'Simpan Retensi',
    retentionWillDelete: 'Akan dihapus',
    retentionDeletedMsg: 'Terhapus',
    retentionDisabled: 'Nonaktif (0 hari)',
    retentionConfirm: 'Tekan tombol konfirmasi sekali lagi untuk benar-benar menghapus.',
    retentionConfirmTitle: 'Hapus Data Kedaluwarsa',
    retentionConfirmWarning: 'Tindakan ini permanen dan tidak dapat dibatalkan.',
    retentionZeroHint: '0 = nonaktif: tidak ada data yang dihapus untuk modul ini.',
    dialogCancel: 'Batal',
    unsavedChanges: 'Belum disimpan',
    fieldNumberRequired: 'Nilai harus berupa angka.',
    fieldOutOfRange: 'Nilai harus antara {min} dan {max}.',
    settingsSaveError: 'Gagal menyimpan pengaturan.',
    retentionDone: 'Penghapusan selesai. Data terkait disegarkan.',
    retentionLoadError: 'Gagal memuat pengaturan retensi.',
    retentionSaveError: 'Gagal menyimpan pengaturan retensi.',
    retentionSaved: 'Pengaturan retensi disimpan.',
    retentionPreviewError: 'Gagal memuat pratinjau.',
    retentionPurgeError: 'Gagal menghapus data.',
    retentionTelemetry: 'telemetry',
    retentionEvent: 'event',
    retentionDaily: 'harian',
    retentionDaysUnit: 'hari',
    retentionNoData: 'Belum ada data untuk modul ini.',
    retentionNothingOldEnough: 'Tidak ada data yang lebih tua dari',
    retentionTotalData: 'Total data',
    retentionOldest: 'tertua',
  },
  en: {
    // Main header
    ...
    // Speed tab
    tabSpeed: 'Speed',
    speedTitle: 'Import Speed Data',
    speedSub: 'Import speeding violation data from a CSV or XLSX file.',
    speedChooseFile: 'Choose File',
    speedUploading: 'Importing...',
    speedDropHint: 'Click this area to choose a CSV/XLSX file',
    speedInserted: 'Imported',
    speedBurst: 'Repeated (dedup)',
    speedDuplicates: 'Duplicates',
    speedNoDriver: 'Driver not registered',
    speedFailed: 'Failed',
    speedSummaryTitle: 'Speed Summary',
    speedTotalEvents: 'Total Violations',
    speedVehiclesAffected: 'Vehicles Affected',
    speedAvgExcess: 'Avg Excess (km/h)',
    speedMaxExcess: 'Max Excess (km/h)',
    speedTopOffender: 'Top Offender',
    speedTrendTitle: 'Speed Violation Trend',
    speedByVehicleTitle: 'Violations per Vehicle',
    speedListTitle: 'Speed Violation List',
    speedPlate: 'Vehicle plate',
    speedSelectDate: 'Select date',
    speedTime: 'Time',
    speedDriver: 'Driver',
    speedLocation: 'Location',
    speedKmh: 'Speed (km/h)',
    speedLimit: 'Limit (km/h)',
    speedExcess: 'Excess (km/h)',
    speedNoData: 'No speed violation data',
    speedRecords: 'records',
    speedSettingsTitle: 'Speed Settings',
    speedDefaultLimit: 'Default Speed Limit (km/h)',
    speedSaveSettings: 'Save Settings',
    speedSettingsSaved: 'Settings saved successfully',
    speedStorageInfo: 'Storage saved',
    speedMonthFilter: 'Month filter for the whole Speed tab',

    // Data retention (ADAS & Speed)
    retentionTitle: 'Data Retention',
    retentionSub: 'Permanently delete data older than N days. 0 = disabled. The number in the box is applied directly when you click Delete Data. Admin only.',
    retentionAdas: 'ADAS (days)',
    retentionSpeed: 'Speed (days)',
    retentionPreviewBtn: 'Preview',
    retentionPurgeBtn: 'Delete Data',
    retentionConfirmBtn: 'Confirm Delete',
    retentionSave: 'Save Retention',
    retentionWillDelete: 'Will delete',
    retentionDeletedMsg: 'Deleted',
    retentionDisabled: 'Disabled (0 days)',
    retentionConfirm: 'Press the confirm button once more to actually delete.',
    retentionConfirmTitle: 'Delete Expired Data',
    retentionConfirmWarning: 'This action is permanent and cannot be undone.',
    retentionZeroHint: '0 = disabled: no data will be deleted for this module.',
    dialogCancel: 'Cancel',
    unsavedChanges: 'Unsaved',
    fieldNumberRequired: 'Value must be a number.',
    fieldOutOfRange: 'Value must be between {min} and {max}.',
    settingsSaveError: 'Failed to save settings.',
    retentionDone: 'Deletion complete. Related data refreshed.',
    retentionLoadError: 'Failed to load retention settings.',
    retentionSaveError: 'Failed to save retention settings.',
    retentionSaved: 'Retention settings saved.',
    retentionPreviewError: 'Failed to load preview.',
    retentionPurgeError: 'Failed to delete data.',
    retentionTelemetry: 'telemetry',
    retentionEvent: 'events',
    retentionDaily: 'daily',
    retentionDaysUnit: 'days',
    retentionNoData: 'No data for this module yet.',
    retentionNothingOldEnough: 'No data older than',
    retentionTotalData: 'Total data',
    retentionOldest: 'oldest',
  },
} as const
